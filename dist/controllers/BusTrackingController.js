...
exports.BusTrackingController = void 0;
const BusTrackingService_1 = require("../services/BusTrackingService");
class BusTrackingController {
    constructor() {
        this.service = new BusTrackingService_1.BusTrackingService();
    }
    /**
     ...
     */
    async getActiveTripBusLocation(req, res) {
        try {
            const { id } = req.params;
            if (!id) {
                return res.status(400).json({
     ...
     */
    async getActiveTripsForStudent(req, res) {
        try {
            const { id } = req.params;
            if (!id) {
                return res.status(400).json({
...
exports.BusTrackingController = BusTrackingController;
exports.default = new BusTrackingController();
//# sourceMappingURL=BusTrackingController.js.map