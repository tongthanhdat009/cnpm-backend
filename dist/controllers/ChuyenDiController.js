...
exports.ChuyenDiController = void 0;
const ChuyenDiService_1 = require("../services/ChuyenDiService");
class ChuyenDiController {
    constructor() {
        this.service = new ChuyenDiService_1.ChuyenDiService();
    }
    /**
     ...
     */
    async getAllChuyenDi(req, res) {
        try {
            const { tai_xe, tuyen_duong, ngay, trang_thai } = req.query;
            let result;
            // Lọc theo tài xế
            if (tai_xe) {
                const idTaiXe = parseInt(tai_xe);
                if (isNaN(idTaiXe)) {
            ...
            // Lọc theo tuyến đường
                ...
                const idTuyenDuong = parseInt(tuyen_duong);
            ...
            // Lọc theo trạng thái
                ...
                result = await this.service.getChuyenDiByTrangThai(trang_thai);
            }
            // Lấy tất cả
            else {
     ...
     */
    async getChuyenDiByHocSinh(req, res) {
        try {
    ...
    async createRecurringChuyenDi(req, res) {
        try {
            const data = req.body;
    ...
    async updateTrangThai(req, res) {
        try {
            ...
            const result = await this.service.updateTrangThai(idNumber, trang_thai);
     ...
     */
    async sendIncidentWarning(req, res) {
        try {
            const { id } = req.params;
...
exports.ChuyenDiController = ChuyenDiController;
exports.default = new ChuyenDiController();
//# sourceMappingURL=ChuyenDiController.js.map